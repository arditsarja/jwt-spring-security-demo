...
//    celesat duhen perbere gjithmon me 16 karaktere

    private static final byte[] keyValue ="anjezaceloaliaj1".getBytes();
    private static final byte[] keyValue1 =
    ...
    private static Key generateKey1() throws Exception {
        return new SecretKeySpec(keyValue1, ALGO);
    }
}